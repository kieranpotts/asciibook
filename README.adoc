...
This project started as a partial fork of https://github.com/lirantal/asciidoc-book-starter/[Liran Tal's AsciiDoc Book Starter]. https://github.com/akosma/eBook-Template/[Adrian Kosmaczewski's eBook Template] was another source of inspiration.
