...
* Output a dark-themed PDF version.

== Documentation

=== Requirements

The only requirements are *Docker Desktop* and a good AsciiDoc editor – try VS Code with the https://marketplace.visualstudio.com/items?itemName=asciidoctor.asciidoctor-vscode[AsciiDoctor extension].
